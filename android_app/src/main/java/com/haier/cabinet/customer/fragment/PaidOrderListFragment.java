...
public class PaidOrderListFragment extends BaseOrderFragment {

    private static final String TAG = "PaidOrderListFragment";
    ...
    public String getRequestUrl(boolean isStart) {
        ...
        String url = Constant.SHOP_DOMAIN
                + "/appapi/index.php?act=member_order&op=order_list&type=pay&v=3"

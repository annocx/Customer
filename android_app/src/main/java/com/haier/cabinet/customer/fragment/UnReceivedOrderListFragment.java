...
public class UnReceivedOrderListFragment extends BaseOrderFragment implements SwipeRefreshLayout.OnRefreshListener{

    private static final String TAG = "UnReceivedFragment";
    ...
    public String getRequestUrl(boolean isStart) {
        ...
        String url = Constant.SHOP_DOMAIN
                + "/appapi/index.php?act=member_order&op=order_list&type=send&v=3"

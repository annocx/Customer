...
public class BaiduPushReceiver extends PushMessageReceiver {
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        if (errorCode == 0) {
            ...
            Log.d(TAG, "绑定ChannleId");
            HttpUtil.pushBaiduChannleId(channelId);
        }
    ...
    public void onNotificationClicked(Context context, String title,
        ...
        String notifyString = "通知点击 title=\"" + title + "\" description=\""
                + description + "\" customContent=" + customContent;
        Log.d(TAG, notifyString);
        String mproId = null;
        // 自定义内容获取方式，mykey和myvalue对应通知推送时自定义内容中设置的键和值
        ...
        // Demo更新界面展示代码，应用请在这里加入自己的处理逻辑
        if(customContent.equals("null") || TextUtils.isEmpty(customContent) || customContent == null){
	...
	private void updateContent(Context context, String content) {
        ...
        Intent intent = new Intent();
        intent.setClass(context.getApplicationContext(), PushMsgListActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        context.getApplicationContext().startActivity(intent);
    }

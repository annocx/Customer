...
public class LineTabIndicator  extends HorizontalScrollView {
    ...
    private int indicatorColor = 0xFFC5013A;
    private int underlineColor = 0x1A000000;
    private int dividerColor = 0x1A000000;
    private int textSelectedColor = 0xFFC5013A;
    private int textUnselectColor = 0xFF666666;
    ...
    public LineTabIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        params.height = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 40, dm);

...
public class MyScrollViews extends RelativeLayout {
	...
	/**
	 * 第二个scrollview的top是否显示的标记
	 */
	private IsShowTop isShowTop;
	...
	public void setIsShowTop(IsShowTop isShowTop) {
		this.isShowTop = isShowTop;
	}
	
	public interface IsShowTop{
		void isShow();
		void isHide();
	}
}

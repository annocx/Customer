...
import com.haier.qr.code.zxing.decoding.PreferencesActivity;
...
final class BeepManager implements
  ...
  synchronized void playBeepSoundAndVibrate() {
	  Log.d("lzx", "playBeepSoundAndVibrate playBeep -- " + playBeep);
	  Log.d("lzx", "playBeepSoundAndVibrate vibrate -- " + vibrate);

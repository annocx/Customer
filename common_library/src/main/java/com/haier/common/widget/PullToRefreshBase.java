...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    /**下拉触发事件 */
    private OnReflushListener mReflushListener;
    ...
    public void setOnReflushListener(OnReflushListener onReListener){
        this.mReflushListener = onReListener;
    }
    ...
    protected void pullHeaderLayout(float delta) {
        ...
        if (isPullRefreshEnabled() && !isPullRefreshing()) { 
            ...
            //lzx added 20151129
            if (null != mReflushListener) {
                mReflushListener.isShow(true);
            }
        }
    }

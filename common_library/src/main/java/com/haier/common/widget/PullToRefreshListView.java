package com.haier.common.widget;

import com.haier.common.R;
import com.haier.common.widget.ILoadingLayout.State;
...
public class PullToRefreshListView extends PullToRefreshBase<ListView> implements OnScrollListener {
    ...
    public void setHasMoreData(boolean hasMoreData) {
        if (!hasMoreData) {
        	hideLoadMoreFooterLayout();
            hideFooterLoadingLayout();
        }
    }
    ...
    public void onPullUpRefreshComplete() {
        ...
        Log.d("lzx", "onPullUpRefreshComplete  " );
        ...
        if (null != adapter || !adapter.isEmpty()) {
        	...
        	if (hasMoreData()) {
        		if (lastVisiblePosition < 2) {
            		...
            		mLoadMoreFooterLayout.setClickLoadMoreLabel(getResources().getText(R.string.pushmsg_center_click_to_load_more_text));
    ...
    public void setScrollLoadEnabled(boolean scrollLoadEnabled) {
        ...
        Log.d("lzx", "scrollLoadEnabled = " + scrollLoadEnabled);
    ...
    public void hideLoadMoreFooterLayout() {
        final Adapter adapter = mListView.getAdapter();
        if (null != mLoadMoreFooterLayout) {
            mLoadMoreFooterLayout.setState(State.NO_MORE_DATA);
            mLoadMoreFooterLayout.setOnClickListener(null);
            if (null == adapter || adapter.isEmpty()) {//无数据
                mLoadMoreFooterLayout.show(false);//lizhixian add 20150713
            }
        }
    }
    ...
    public void hideFooterLoadingLayout() {
        ...
        if (null != footerLoadingLayout) {
            ...
            if (null == adapter || adapter.isEmpty()) {//无数据
                footerLoadingLayout.show(false);//lizhixian add 20150713
            }
        }
    }
}
